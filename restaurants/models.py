...
class RestaurantBrand(models.Model):
    owner       = models.ForeignKey(User, on_delete=models.CASCADE, related_name="owned_restaurant_brands")
...
class Branch(models.Model):
    brand   = models.ForeignKey(RestaurantBrand, on_delete=models.CASCADE, related_name="branches")
    name    = models.CharField(max_length=255)
    ...
    # Auto-confirm new bookings without partner review
    auto_confirm     = models.BooleanField(default=False)

    # {"mon": ["10:00", "22:00"], "tue": ["10:00", "22:00"], ...}
    working_hours = models.JSONField(default=dict, blank=True)
    # Optional restriction on when bookings can START (subset of working_hours)
